  ...
  return (
    <div className='flex flex-col md:flex-row'>
      ...
      <div className='flex-1'>
        <h1 className='text-4xl font-semibold border-b p-3 text-slate-700 mt-5'>Listing results:</h1>
        <div className='p-7 flex flex-wrap gap-4'>
          ...
          {showMore && (<button onClick={handleShowMoreClick} className='text-green-700 hover:underline p-7 w-full text-center'>Show more</button>)}
        </div>
      </div>
    </div>
  )
